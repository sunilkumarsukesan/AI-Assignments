...
class covid_analysis_chart(data_util, pandas_util, visualization_util):
    ...
    def plot_top10_confirmed_bar(self):
        ...
        self.plot_chart(chart_type='bar', x=df1['Country/Region'], y=df1['Confirmed'], title='Top 10 Countries by Confirmed Cases', xlabel='Country/Region', ylabel='Number of Confirmed Cases', rotation=45, color='orange', edgecolor='black',grid=True)
